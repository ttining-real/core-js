...
// 단항 연산자
let unary = +a;
console.log('unary : ',unary); // 10

// 이항 연산자
// let binary = a + b;
let binary = Number(a) + Number(b);
console.log('binary : ',binary); // 40

// 삼항 연산자
// 암시적 형변환이 일어나서 a의 '10'이 10이 된다.
// let ternary = a >= 10;
// let ternary = a >= 10 ? true : false;
let ternary = a >= 10 ? '참.' : '거짓.';
console.log('ternary : ',ternary); // 참.
...
// 산술 연산자: 거듭 제곱
let power = 2 ** 53;
console.log('power : ', power); // 9007199254740992
...
// .concat 배열 병합 (배열의 메서드) - 레거시 방식이라서 잘 안 쓰인다.
